...
<div class="container">
    <div class="card">
        <div class="card-heading">
            <h4 class="mt-3 ms-3">Data Transaksi Laundry</h4>
        </div>
        <div class="card-body">

            <a href="transaksi_tambah.php" class="btn btn-sm btn-info pull-right text-white">Transaksi Baru</a>
            ...
            <table class="table table-bordered table-striped">
                ...
                $data = mysqli_query($connect, "SELECT * from pelanggan, transaksi where transaksi_pelanggan=pelanggan_id order by transaksi_id desc");
                $no = 1;
