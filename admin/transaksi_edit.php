    ...
    <div class="panel ms-5 mb-5 ">
        <div class="panel">
            ...
            <div class="col-md-8 col-md-offset-2">
                ...
                $transaksi = mysqli_query($connect, "select * from transaksi where transaksi_id='$id'");
                while ($t = mysqli_fetch_array($transaksi)) {
                    ...
                    <form method="post" action="transaksi_update.php">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="tgl_selesai" required="required" value="<?php echo $t
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <?php
                            // menyimpan id transaksi ke variabel id transaksi
                            $id_transaksi = $t['transaksi_id'];
                            // menampilkan pakaian-pakaian dari transaksi yang ber id di atas
                            $pakaian = mysqli_query($connect, "select * from pakaian where pakaian_transaksi='$id_transaksi'");
