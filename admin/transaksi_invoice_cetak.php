...
<head>
    <title class="text-center">Sistem Informasi Laundry</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="col-md-10 col-md-offset-1">
            ...
            $transaksi = mysqli_query($connect, "select * from transaksi, pelanggan where transaksi_id='$id' and transaksi_pelanggan=pelanggan_id");
            while ($t = mysqli_fetch_array($transaksi)) {
                ?>
                <center>
                    <h2>LAUNDRY SMKN 7 BALEENDAH </h2>
                </center>
                <h3 class="text-center">INVOICE-<?php echo $t['transaksi_id']; ?></h3>
                ...
                <table class="table table-bordered table-striped">
                    ...
                    $pakaian = mysqli_query($connect, "select * from pakaian where pakaian_transaksi='$id'");
